        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.company}>
                <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: 15 }}>
                    <Image source={{ uri: 'https://cdn-icons-png.flaticon.com/128/993/993891.png' }} style={styles.img} />
                    <Text>'Company Name'</Text>
                </View>
                <TouchableOpacity
                    style={{ backgroundColor: 'white', marginRight: 15 }}
                >
                    <Image source={{ uri: 'https://cdn-icons-png.flaticon.com/128/1828/1828427.png' }} style={{ width: 30, height: 30, }} />
