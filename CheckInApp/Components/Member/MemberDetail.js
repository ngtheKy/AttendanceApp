        ...
        <ScrollView style={styles.container}>
            <View className='form-input' style={styles.input}>
                ...
                <View className='Account-login' style={styles.form}>
                    <Image source={{uri: `data:image/jpeg;base64,${imgData}`}} style={styles.img}/>
                    <Text style={styles.label}>Họ và tên</Text>
                    <Text style={styles.info}>{item.HoNV}{item.TenNV}</Text>
                ...
                <View className='Mem-profile' style={styles.form}>
                    ...
                    {`${item.Gioitinh}` == 1 ? <Text style={styles.info}>Nam</Text> : <Text style={styles.info}>Nữ</Text>}
            ...
            <TouchableOpacity
                onPress={() => navigation.navigate('Thay đổi thông tin nhân viên', {id: item.id})}
                style={styles.button}
            >
                <MaterialCommunityIcons name='update' size={20} color='white' style={styles.buttonTxt}>
